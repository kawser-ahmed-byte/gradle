            ...
            if (propertyType == null) {
                validationContext.visitPropertyProblem(problem ->
                    problem
                        ...
                        .solution("Add " + displayName) // TODO (donat) use contextualSolution
            ...
            if (annotationHandler == null) {
                validationContext.visitPropertyProblem(problem ->
                    problem
                        ...
                        .solution("Use a different annotation, e.g one of " + toListOfAnnotations(propertyAnnotationHandlers.keySet())) // TODO (donat) use contextualSolution
                );
                continue;
            }
                ...
                if (!allowedModifiersForPropertyType.contains(annotationType)) {
                    validationContext.visitPropertyProblem(problem ->
                        problem
                            ...
                            .solution("Remove the '@" + annotationType.getSimpleName() + "' annotation")); // TODO (donat) use contextualSolution
                    ...
                    validationContext.visitPropertyProblem(problem ->
                        problem
                            ...
                            .solution("Use a different annotation, e.g one of " + toListOfAnnotations(allowedPropertyModifiers)) // TODO (donat) use contextualSolution
                    );
                }
            }
