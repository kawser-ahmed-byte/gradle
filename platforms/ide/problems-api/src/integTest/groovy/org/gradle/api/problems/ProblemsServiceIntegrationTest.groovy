...
class ProblemsServiceIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "can emit a problem with minimal configuration"() {
        ...
        problem['context']['locations'] == [[buildTreePath: ':reportProblem']]
    }
    ...
    def "can emit a problem with offset location"() {
        ...
        then:
        collectedProblem['context']["locations"] == [['path': 'test-location', 'offset': 1, 'length': 2], [buildTreePath: ':reportProblem']]
    }
    ...
    def "can emit a problem with file and line number"() {
        ...
        then:
        collectedProblem['context']["locations"] == [["path": "test-location", "line": 1, "column": 2, 'length': -1], ['buildTreePath': ':reportProblem']]
    }
