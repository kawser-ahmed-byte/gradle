    ...
    private void collectValidationProblem(Node producer, Node consumer, TypeValidationContext validationContext, String consumerProducerPath) {
        validationContext.visitPropertyProblem(problem ->
            problem.typeIsIrrelevantInErrorMessage()
                ...
                .solution("Declare task '" + producer + "' as an input of '" + consumer + "'") // TODO (donat) use contextualSolution
                .solution("Declare an explicit dependency on '" + producer + "' from '" + consumer + "' using Task#dependsOn") // TODO (donat) use contextualSolution
                .solution("Declare an explicit dependency on '" + producer + "' from '" + consumer + "' using Task#mustRunAfter") // TODO (donat) use contextualSolution
        );
    }
