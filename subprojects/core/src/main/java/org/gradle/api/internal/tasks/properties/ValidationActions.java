    ...
    private static void reportMissingInput(PropertyValidationContext context, String kind, String propertyName, File input) {
        context.visitPropertyProblem(problem -> {
            ...
            problem
                ...
                .solution("Make sure the " + lowerKind + " exists before the task is called") // TODO (donat) we need contextualSolution here
                .solution("Make sure that the task which produces the " + lowerKind + " is declared as an input"); // TODO (donat) we need contextualSolution here
        });
    }
    ...
    private static void reportUnexpectedInputKind(PropertyValidationContext context, String kind, String propertyName, File input) {
        context.visitPropertyProblem(problem -> {
            ...
            problem
                ...
                .severity(Severity.ERROR)
                .details("Expected an input to be a " + lowerKind + " but it was a " + actualKindOf(input)) // TODO (donat) contextualSolution
                .solution("Use a " + lowerKind + " as an input") // TODO (donat) contextualSolution
                .solution("Declare the input as a " + actualKindOf(input) + " instead"); // TODO (donat) contextualSolution
        });
    }
    ...
    private static void reportCannotWriteToDirectory(String propertyName, PropertyValidationContext context, File directory, String cause) {
        context.visitPropertyProblem(problem ->
            problem
                ...
                .solution("Make sure that the '" + propertyName + "' is configured to a directory") // TODO (donat) contextualSolution
        );
    }
    ...
    private static void reportFileTreeWithFileRoot(String propertyName, PropertyValidationContext context, File directory) {
        context.visitPropertyProblem(problem ->
            problem
                ...
                .solution("Make sure that the root of the file tree '" + propertyName + "' is configured to a directory") // TODO (donat) contextualSolution
        );
    }
    ...
    private static void reportCannotWriteFileToDirectory(String propertyName, PropertyValidationContext context, File file) {
        context.visitPropertyProblem(problem ->
            problem
                ...
                .severity(Severity.ERROR)
                .solution("Configure '" + propertyName + "' to point to a file, not a directory") // TODO (donat) contextualSolution
                .solution("Annotate '" + propertyName + "' with @OutputDirectory instead of @OutputFiles") // TODO (donat) contextualSolution
        );
    }
    ...
    private static void reportCannotCreateParentDirectories(String propertyName, PropertyValidationContext context, File file, File ancestor) {
        context.visitPropertyProblem(problem ->
            problem
                ...
                .solution("Configure '" + propertyName + "' to point to the correct location") // TODO (donat) contextualSolution
        );
    }
        ...
        if (context.isInReservedFileSystemLocation(location)) {
            context.visitPropertyProblem(problem ->
                problem
                    ...
                    .solution("Select a different output location") // TODO (donat) contextualSolution
            );
        }
    }
